...
const messages = {
  ...
  ch: {
    message: {
      ...
      about: {
        content:
          "2022開始擔任銀行金融業程式開發人員, 接手過前端專案開發(行內系統)與維護, 後端維護, 前端使用<b>Vuejs與Vite</b>進行從無到有的開發, 包含系統架構規劃與建置(AlmaLinux, Ubuntu), 配合三層式架構與Nginx代理進行開發, 使用Jenkins與Gitea進行CI/CD自動化部屬, 後端維護公司產品(網路銀行, 行動銀行, 數位銀行), MID行動裝置驗證功能開發, 包含Redis, postgreSql使用經驗.<br/> 2023年底因緣際會加入銀行數位轉型案, 與廠商合作開發全新數位行動銀行專案, 使用spring boot 3與Vuejs開發, 配合Azure devops進行敏捷開發與專案管理及CI/CD, 經手開發功能包含貸款, 基金, 信用卡等功能開發與系統分析,<br/> 對自己的期許是能夠一直保持對程式的熱誠並向上精進, 也希望能夠接觸更多領域及行業",
      },
    },
  },
};
